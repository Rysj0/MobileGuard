...
public class ContactInfoParser {
    ...
    public static List<ContactInfo> getSimContact(Context context) {
        ...
        if (mCursor != null) {
            while (mCursor.moveToNext()) {
                ...
                //取得电话号码
                int numherFieldColumnIndex = mCursor.getColumnIndex("number");
                info.phone = mCursor.getString(numherFieldColumnIndex);
                infos.add(info);
            }
        }
        mCursor.close();
